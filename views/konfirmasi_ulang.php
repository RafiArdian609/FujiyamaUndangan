...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $controller->handleConfirmationForm();
...
<head>
    ...
    <title>Konfirmasi Ulang Kehadiran</title>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="breadcrumb-text">
                        <p>Konfirmasi Ulang Kehadiran</p>
                        <h1>Pastikan Kehadiran Anda Tersimpan dengan Benar</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="form-title">
                        <h2>Konfirmasi Ulang Kehadiran Anda!</h2>
                        <p>Kami dengan senang hati mengundang Anda untuk bergabung dalam perayaan Sakura Matsuri di Fujiyama Restaurant. Pastikan kehadiran Anda dengan mengisi form di bawah ini.</p>
                    </div>
